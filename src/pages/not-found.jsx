...
const NotFound = () => {
  return (
    <>
      <main className="max-w-5xl h-screen mx-auto flex flex-col gap-6 items-center justify-center">
        <div className=" flex ">
        ...
        <Link
          to="/"
          className="underline underline-offset-4 text-gray-400 hover:text-slate-200"
        >
          Back to Home
        </Link>
      </main>
